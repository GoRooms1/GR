...
switch ($hotel_type) {
   ...
   case 4:
    ...
    private function getCost(Request $request)
    {
        ...
        list($type, $condition, $value) = explode('.', $cost_raw);
        $value = explode('-', $value);
    ...
    public function address(Request $request, $city, $param1 = null, $param2 = null, $param3 = null, $param4 = null)
    {
        ...
        $findParam = function ($param) use ($param1,$param2,$param3,$param4)
        {
            switch (true)
            {
                case substr($param1 ?: '', 0, strlen($param)) === $param: return $param1;
                case substr($param2 ?: '', 0, strlen($param)) === $param: return $param2;
                case substr($param3 ?: '', 0, strlen($param)) === $param: return $param3;
                case substr($param4 ?: '', 0, strlen($param)) === $param: return $param4;
            }
            return null;
        };
