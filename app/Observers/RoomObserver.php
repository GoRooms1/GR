...
class RoomObserver
{
  ...
  //TODO: Переделать.
  //TODO: Отель падает на модерацию с блокировками полей после создание первой комнаты
  //TODO: Отель изначально везде false, и не виден никому, после создание комнаты отель виден модератору
  /**
