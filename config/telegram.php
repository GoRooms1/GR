...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            ...
            'commands' => [                
                Domain\Bot\Commands\StartCommand::class,
                Domain\Bot\Commands\SubCommand::class,
                Domain\Bot\Commands\UnsubCommand::class,
                Domain\Bot\Commands\HotelsCommand::class,
            ],
        ],
    ...
    */
    'commands' => [
        Domain\Bot\Commands\HelpCommand::class,
    ],
