<template>
    <div class="pt-1 lg:hidden">  
       <button @click="show()">
            <svg width="24" height="16" viewBox="0 0 24 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.3335 14.6665H22.6668" stroke="#6170FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M1.3335 8H22.6668" stroke="#6170FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M1.3335 1.33325H22.6668" stroke="#6170FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
        </button>					
    </div>
   ...
   >
        ...
        <div class="flex flex-col px-6 py-8 bg-white rounded-3xl w-full mb-[17%]">
            ...
            <responsive-nav-link title="Контакты" :href="route('contact')" classes="bg-[url(/img/link5_1.svg)] hover:bg-[url(/img/link5_2.svg)]"/>
            <responsive-nav-link disabled title="Избранное" classes="bg-[url(/img/link6_1.svg)] hover:bg-[url(/img/link6_2.svg)]"/>
            <responsive-nav-link title="Личный кабинет" :href="'/login'" classes="bg-[url(/img/link7_1.svg)] hover:bg-[url(/img/link7_2.svg)]"/>
