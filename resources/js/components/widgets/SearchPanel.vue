<template>
  ...
  >
    <div class="relative">
      <div
        data="search-input"
        class="shadow-xl w-full bg-white md:rounded-t-[16px] rounded-t-[24px] md:rounded-b-none rounded-b-[24px] md:p-[8px] p-0 px-[8px] py-[12px] flex items-center"
      >
        <button class="p-[8px]">
          <svg
            width="24"
      ...
      <div
        data="search-input-content"
        class="absolute z-[11] w-[75%] max-[768px]:w-full flex hidden flex-col py-3 px-4 bg-white rounded-b-[24px] cursor-default scrollbar overflow-y-auto max-h-[60vh] gap-[8px] max-[768px]:text-[0.8125rem] shadow-xl"
      >
        ...
        >
          <img src="" class="absolute inset-y-[11px] left-[13px]" />
