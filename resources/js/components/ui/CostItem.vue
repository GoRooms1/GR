<template>
    <div v-if="cost.value > 0" class="xl:mb-2">
        <div v-if="cost.discount" class="font-bold text-sm xs:text-base flex items-center absolute xl:static top-2 pl-4 xl:pl-0">
            <div class="mr-2">
        ...
        <div class="text-sm xs:text-base font-bold">
            <span :class="cost.discount ? 'line-through' : ''">{{ cost.value }}</span> ₽/{{ cost.name }}
        </div>
