<template>
    <div v-click-outside="hide" class="relative" :class="collapsed ? 'z-[1]' : 'z-[5]'">
        ...
        >
            ...
            <svg v-if="selectedOption == null || notNull == true" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" class="block" :class="collapsed ? '' : 'rotate-180'">
