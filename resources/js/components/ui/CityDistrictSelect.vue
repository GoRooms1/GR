<template>
  <div
    ...
    :class="collapsed ? 'z-[1]' : 'z-[5]' + ' ' + position"
  >
    <button
      @click="toggle()"
    ...
    >
      ...
      <div
        class="filter-scrollbar2 p-[16px] bg-white flex flex-col gap-[8px] max-h-[296px] md:max-h-[calc(45vh-48px)] overflow-y-auto rounded-[8px] shadow-xl"
      >
