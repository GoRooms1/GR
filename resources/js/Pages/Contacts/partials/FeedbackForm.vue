...
<template>
    <form @submit.prevent="submit" class="w-full">
        <div v-if="$page.props.flash.message" class="w-full bg-white rounded-3xl p-4 flex flex-col items-center text-center">
            ...
            <div class="font-semibold mb-4 mt-20">
        ...
        <div v-if="!$page.props.flash.message" class="w-full bg-white rounded-3xl p-4">
            ...
            <div class="flex-wrap lg:flex text-sm leading-4">
                ...
                <label class="block w-full mb-2 xl:mb-2">
                    ...
                    <input v-model="form.name" name="name" @input="validate" class="w-full h-8 rounded-md py-2 px-2 placeholder-zinc-500" placeholder="Как к вам обращаться" wfd-id="id6">
                </label>
                <label class="block w-full mb-2 xl:mb-2">
                    <span class="flex">
                    ...
                    <input v-model="form.phone" name="phone" @input="validate" v-mask="'+7 (###) ### ## ##'" type="text" class="w-full h-8 rounded-md py-2 px-2 placeholder-zinc-500" placeholder="+7 (___) ___ __ __" wfd-id="id7">
                </label>
                <label class="block w-full mb-2 xl:mb-2">
                    <span class="flex">
                    ...
                    <input v-model="form.email" name="email" @input="validate" type="text" class="w-full h-8 rounded-md py-2 px-2 placeholder-zinc-500" placeholder="Ваша@почта" wfd-id="id8">
                </label>
                </div>
