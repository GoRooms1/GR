    ...
    <div class="container mx-auto md:px-4 px-0 md:mt-[113px] mt-0 ">
        <div>
            <div class="flex md:flex-col flex-col-reverse">
                <div class="w-full flex  sm:items-center items-start sm:gap-[10px] gap-[32px] justify-between flex-col sm:flex-row md:px-0 px-4 mb-[32px] md:mb-0">
                    <div>
                        <span class="text-[16px] leading-[19px]">{{ hotel?.type?.single_name ?? 'Отель' }}</span>
                        <h1 class="text-[28px] leading-[33px] font-semibold">{{ hotel?.name }}</h1>
                    </div>
                    <div class="w-full mb-[32px] md:mb-0 sm:w-auto flex items-center gap-[24px] sm:justify-start justify-between">
                        <div class="flex items-center gap-[8px]">
                            <span class="text-[14px] leading-[16px] font-semibold">Рейтинг</span>
                ...
                <div class="flex  items-start justify-between md:flex-row flex-col-reverse gap-[32px] md:mt-[56px] mt-0 md:mb-[64px] mb-[48px] w-full">
                    <div v-html="hotel?.description" class="sm:block hidden md:w-[30%] w-full md:px-0 px-4"></div>
                    <tabs @changed="redrawMap">
                        ...
                        <tab title="На карте" class="min-h-[416px] rounded-[24px] overflow-hidden">
                                ...
                                <div class="swiper-feed-wrapper relative overflow-hidden w-full h-[100%]">
                                    <button class="swiper-feed-button-prev cursor-pointer absolute top-[50%] transform translate-1/2 left-0 w-[32px] h-[32px] bg-white rounded-[8px] sm:flex hidden items-center justify-center">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.084 5.75037L7.91732 9.91703L12.084 14.0837" stroke="#515561" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </button> 
                                    <swiper                
                                        :slides-per-view="2" 
                                            ...
                                            <div class="bg-white p-[24px] rounded-[24px]">
                                                <div class="flex items-center justify-between py-[6px] mb-[24px]">
                                                    <div class="flex items-center gap-[8px]">
                                                        ...
                                                        <span class="text-[14px] leading-[16px] font-semibold">10</span>
                                                    </div>
                                                    <span class="text-[16px] leading-[19px] font-semibold">Имя{{ item }}</span>
                                                    <span class="text-[12px] leading-[14px]">01 января 2023</span>
                                                </div>
                                                <p class="text-[14px] leading-[16px] mb-[24px]">Отзыв{{ item }}</p>
                                                <div class="grid grid-cols-2 gap-x-[24px] gap-[16px]">
                                                    <div>
                                                        <div class="flex items-center justify-between mb-[8px]">
                                                            <span class="text-[12px] leading-[14px]">Расположение</span>
                                                            <span class="text-[12px] leading-[14px]">10</span>
                                                        </div>
                                                        <div class="w-full h-[4px] bg-[#EAEFFD] rounded-[2px] overflow-hidden">
                                                            <div class="w-[100%] h-full bg-[#6170FF] rounded-[2px]"></div>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <div class="flex items-center justify-between mb-[8px]">
                                                            <span class="text-[12px] leading-[14px]">Персонал</span>
                                                            <span class="text-[12px] leading-[14px]">10</span>
                                                        </div>
                                                        <div class="w-full h-[4px] bg-[#EAEFFD] rounded-[2px] overflow-hidden">
                                                            <div class="w-[100%] h-full bg-[#6170FF] rounded-[2px]"></div>
                                                    ...
                                                    <div>
                                                        <div class="flex items-center justify-between mb-[8px]">
                                                            <span class="text-[12px] leading-[14px]">Чистота</span>
                                                            <span class="text-[12px] leading-[14px]">10</span>
                                                        </div>
                                                        <div class="w-full h-[4px] bg-[#EAEFFD] rounded-[2px] overflow-hidden">
                                                            <div class="w-[100%] h-full bg-[#6170FF] rounded-[2px]"></div>
                                                    ...
                                                    <div>
                                                        <div class="flex items-center justify-between mb-[8px]">
                                                            <span class="text-[12px] leading-[14px]">WI-FI</span>
                                                            <span class="text-[12px] leading-[14px]">10</span>
                                                        </div>
                                                        <div class="w-full h-[4px] bg-[#EAEFFD] rounded-[2px] overflow-hidden">
                                                            <div class="w-[100%] h-full bg-[#6170FF] rounded-[2px]"></div>
                                                    ...
                                                    <div>
                                                        <div class="flex items-center justify-between mb-[8px]">
                                                            <span class="text-[12px] leading-[14px]">Комфорт</span>
                                                            <span class="text-[12px] leading-[14px]">10</span>
                                                        </div>
                                                        <div class="w-full h-[4px] bg-[#EAEFFD] rounded-[2px] overflow-hidden">
                                                            <div class="w-[100%] h-full bg-[#6170FF] rounded-[2px]"></div>
                                                    ...
                                                    <div>
                                                        <div class="flex items-center justify-between mb-[8px]">
                                                            <span class="text-[12px] leading-[14px]">Цена</span>
                                                            <span class="text-[12px] leading-[14px]">10</span>
                                                        </div>
                                                        <div class="w-full h-[4px] bg-[#EAEFFD] rounded-[2px] overflow-hidden">
                                                            <div class="w-[100%] h-full bg-[#6170FF] rounded-[2px]"></div>
                                    ...
                                    <button class="swiper-feed-button-next cursor-pointer absolute top-[50%] transform translate-1/2 right-0 w-[32px] h-[32px] bg-white rounded-[8px] sm:flex hidden items-center justify-center">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.91602 14.2496L12.0827 10.083L7.91602 5.9163" stroke="#515561" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </button>    
                                </div>                       
                            </div>
            ...
            <div class="grid md:grid-cols-3 grid-cols-1 items-start sm:gap-[30px] gap-[32px] md:px-0 px-4">
                <div class="md:pt-[24px] pt-0">
                    <p class="text-[22px] leading-[26px] font-semibold mb-[16px]">Детально об отеле</p>
                    <div class="flex flex-wrap gap-[16px]">
                        <div v-for="attr in hotel?.attrs" class="py-[8px] px-[12px] border border-solid border-[#6170FF] rounded-[8px] text-[14px] leading-[16px]">{{ attr.name }}</div>
                    </div>
                </div>
                <div class="sm:bg-white bg-transparent sm:p-[24px] p-0 rounded-[24px] row-start-1 md:col-start-2">
                    <p class="text-[22px] leading-[26px] font-semibold lg:mb-[24px] mb-[16px]">Расположение</p>
                    <div class="flex flex-col gap-[8px]">
                        <hotel-address :address="hotel?.address"/>
                        <hotel-metro-item v-for="metro in hotel?.metros" :metro="metro" :address="hotel?.address"/>
                    </div>
                </div>
                <div class="sm:bg-white bg-transparent sm:p-[24px] p-0 rounded-[24px]">
                    <p class="text-[22px] leading-[26px] lg:mb-[24px] mb-[16px] font-semibold">Стоимость проживания</p>
    ...
    export default {
        ...
        methods: {
            initMap() {
                ...
                geometry: {
                    type: "Point",
                    coordinates: [this.hotel.address.geo_lat, this.hotel.address.geo_lon]
                },
                }, {            
                preset: 'islands#icon',            
                draggable: false
