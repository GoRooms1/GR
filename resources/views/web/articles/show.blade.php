...
<div itemscope itemtype="https://schema.org/Article">
    ...
    <meta itemprop="author" content="{{ Domain\Settings\Models\Settings::option('address') }}">
    ...
    <div itemprop="publisher" itemscope itemtype="https://schema.org/Organization">
        ...
        <meta itemprop="telephone" content="{{ Domain\Settings\Models\Settings::option('phone') }}">
