...
@section('content')
  <div class="px-4 mt-4">
    <div class="shadow w-100 p-0 m-0">
      ...
      <div class="p-0">
        <div class="mb-2">
          <form action="{{ route('moderator.bookings.index', $hotel->id) }}" method="get" class="w-100 p-2">
            ...
            <div class="row w-100">
              <div class="col-auto ml-auto">
                ...
                <a href="{{ route('moderator.bookings.index', $hotel->id) }}" class="btn btn-danger">Сброс</a>
              </div>
            </div>
          </form>          
        </div>        
              ...
              <tr id="booking_{{$booking->id}}">
                ...
                <td>
                  <div class="d-flex">                   
                    ...
                    <button disabled data="booking-save" data-action-url="{{ route('moderator.bookings.update', $booking) }}" class="btn btn-primary">Сохранить</button>
                  </div>                  
                </td>
              </tr>
            @endforeach
