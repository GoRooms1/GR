                        ...
                        <table class="footer" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                <td style="color: rgb(29 78 216); font-size: 14px;">
                                    <strong>Теперь вы можете получать бронирования в Телеграмм!</strong>
                                    <a href="https://t.me/GoRoomsBot" target="_blank" style="margin: 0; padding: 0;">
                                        <img src="{{ asset('img/ico-tg.png') }}" alt="tg" style="max-height: 14px; margin: 0 5px;">
                                    </a>                                    
                                    <br>
                                    <strong>Если Вам неудобно следить за бронированиями по e-mail, у нас заработал сервис уведомлений в Телеграмм.</strong>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
