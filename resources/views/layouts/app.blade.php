...
<body>
        ...
        <nav id="js-menu-wrapper" class="header-menu-wrapper">
            <div class="container header-menu-container">
                <ul id="js-menu" class="header-menu">
                    ...
                    <li class="header-menu-item">
                        <a href="{{ route('search.map') }}" class="header-menu-link">Поиск по карте <img src="{{ asset('img/ico-search.svg') }}" alt=""></a>
                    </li>
                    <li class="header-menu-item">
        ...
        <div class="container footer-container">
            ...
            <div class="footer-bottom">
                <div class="footer-contacts">
                    ...
                    <a href="mailto:{{ Settings::option('email') }}" class="footer-contacts-item footer-contacts-item-email">
    ...
    <div id="book-popup" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog book-modal-dialog" role="document">
            <div class="modal-content">
                <button type="button" class="close modal-close" data-dismiss="modal" aria-label="Close"></button>
                <div class="h3 modal-title">Вы выбрали номер “Назване номера” в категории De Lux в объекте размещения “Гранд
                    отель”</div>
                <form id="book-form" class="book-form" action="{{ route('booking.room', 50) }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input id="book-name" name="book-name" type="text" class="form-control" placeholder="Имя*" required>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input id="book-tel" name="book-tel" type="tel" class="form-control" placeholder="Тел:* +7 (___) ___ __ __" required>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input id="book-email" name="book-email" type="email" class="form-control" placeholder="E-mail">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group form-group-dates">
                                <div class="form-group-date">
                                    ...
                                    <input id="from-date" name="from-date" type="date" class="form-control form-control-date" placeholder="06.06.2020" required>
                                    <input id="from-time" name="from-time" type="text" class="form-control form-control-time js-time" placeholder="14:00" required>
                                </div>
                                <div class="form-group-date">
                                    <p class="form-group-date-label">Выезд:<span>*</span></p>
                                    <input id="to-date" name="to-date" type="date" class="form-control form-control-date" placeholder="06.06.2020" required>
                                    <input id="to-time" name="to-time" type="text" class="form-control form-control-time js-time" placeholder="14:00" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="form-group">
                                <textarea name="book-comment" id="book-comment" class="form-control" placeholder="Комментарий"></textarea>
                            </div>
